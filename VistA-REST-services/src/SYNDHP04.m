SYNDHP04 ; HC/fjf/art - HealthConcourse - retrieve patient procedures ;04/12/2019
...
PATPRC(RETSTA,NAME,SSN,DOB,GENDER,FRDAT,TODAT) ; get procedures for a patient by traits
 ...
 ; Output:
 ;   RETSTA  - a delimited string that lists SNOMED CDT codes for the patient procedures
 ;           - ICN^SCT code|descrption|CPT code|date|identifier^...
 ;

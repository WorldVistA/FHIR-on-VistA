...
public class HcFhirServlet extends RestfulServer {
    ...
    public void initialize() {
        ...
        providers.add(new PractitionerProvider(service));
        providers.add(new AllergyProvider(service));
        providers.add(new AppointmentProvider(service));
        providers.add(new CarePlanProvider(service));
        providers.add(new DiagnosticReportProvider(service));
        providers.add(new EncounterProvider(service));
        providers.add(new FlagProvider(service));
        providers.add(new GoalProvider(service));
        providers.add(new ImmunizationProvider(service));
        providers.add(new MedicationAdministrationProvider(service));
        providers.add(new MedicationDispenseProvider(service));
        providers.add(new MedicationStatementProvider(service));
        providers.add(new CompositionProvider(service));
        providers.add(new ProcedureProvider(service));

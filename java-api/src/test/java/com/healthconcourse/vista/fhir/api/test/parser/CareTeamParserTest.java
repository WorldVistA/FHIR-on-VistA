...
public class CareTeamParserTest {
    ...
    public void TestSuccessfulCareTeamParse() throws ParseException {
        ...
        Date expectedDate = sdf.parse("2011-10-27");
        Assert.assertEquals("Correct appointment start date and time", expectedDate, result.get(1).getPeriod().getStart());
    }
    ...
    public void TestSuccessfulSingleCareTeamParse() {
        String json = "{\n" +
                ...
                "                    \"practitionerId\": 991,\n" +
                "                    \"practitionerResId\": \"V-500-200-11389\",\n" +

...
public class VistaObservationServiceTest {
    ...
    @Test
    public void testGetObservationsByIdSuccess() {
        VistaObservationService service = new VistaObservationService(new MockVistaData());

        List<Observation> results = service.getObservationsByPatient("5000001533V676621");

        assertTrue(results.size() == 18);
    }

    @Test
    public void testGetObservationsByIdFailure() {
        VistaObservationService service = new VistaObservationService(new MockVistaData());

        List<Observation> results = service.getObservationsByPatient("444");
